...
export class MarkService {
  ...
  getMarksByDays(userId: number, subjectId: number):Observable<any>{
    return this.http.get(MARK_API + userId + "/getMarksByDay/" + subjectId);
  }
  getMarksByTopics(userId: number, subjectId: number):Observable<any>{
    return this.http.get(MARK_API + userId + "/getMarksByTopics/" + subjectId);
  }
}
